from recipes.models import Description, Meal, Cuisine, DietaryPreference, Equipment, Allergen, Ingredient, IngredientCategory, Title, Unit, CookingMethod, Occasion
